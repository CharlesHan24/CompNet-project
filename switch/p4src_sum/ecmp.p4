				  ...
				  inout standard_metadata_t standard_metadata)
{
	...
	action update_using_sketch0(){
	   ...
	   if(meta.SFH_target_array==0){
		...
		//    hdr.SFH.sfh_delay7=meta.tmp07;
		   ...
		   hdr.SFH.sfh_delay0 = 1;
		   hdr.SFH.sfh_delay1 = 1;
		   hdr.SFH.sfh_delay2 = 1;
		   hdr.SFH.sfh_delay3 = 1;
		   hdr.SFH.sfh_delay4 = 1;
		   hdr.SFH.sfh_delay5 = 1;
		   hdr.SFH.sfh_delay6 = 1;
		   hdr.SFH.sfh_delay7 = 1;
	...
	table update_SFH{
		...
		size=256;
		//default_action=NoAction;
		default_action=update_using_sketch0;
	}
	...
	{   
		if (hdr.ipv4.isValid()&&hdr.ipv4.ttl > 1) {
			...
			hdr.SFH.sfh_delay0 = (bit<32>)5;
			hdr.SFH.sfh_delay1 = (bit<32>)6;
